module.exports = function (grunt) {
  ...
  grunt.initConfig({
        ...
        files: [
          {
            ...
            "assets/redesign-theme/uikit/common.css":
              "sources-redesign/theme-common.scss",
            "assets/redesign-theme/uikit/cssdebug.css":
              "sources-redesign/cssdebug.scss",
          },
        ],
      },
      legacy: {
        files: {
          "assets/trudvsem-theme/uikit/common.css":
            "sources-trudvsem/theme-common.scss",
        },
      },
      rdev: {
        options: {
    ...
    svgstore: {
      ...
      redesign: {
        files: {
          "assets/redesign-theme/uikit/icon/icons.svg":
            "sources-redesign/ui-kit/icon/icons/*.svg",
        },
      },
      legacy: {
        files: {
          "assets/trudvsem-theme/uikit/icon/icons.svg":
            "sources-trudvsem/ui-kit/icon/icons/*.svg",
        },
      },
    },
    svgmin: {
          ...
          formatter: function (results) {
            return results
              .map((element) => {
                ...
                let source = element.source.replace(/\\/g, "/");
                let message = "";
