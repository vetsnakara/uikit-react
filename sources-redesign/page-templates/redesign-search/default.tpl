  ...
  <body class="body">
    ...
    <header class="header">
      <div class="header__wrapper">
        ...
        <div class="search-content header__search" data-name="search-content">
          <!-- Обертка в виде div только для шаблона поисковой выдачи, нужно для фронта -->
        ...
        <div class="search-content__mobile-container">
          ...
          <button class="search-content__mobile-button" type="button" data-toggle="modal" data-content="all-filters" data-target="#all-filters-modal-4">
            <svg class="icon icon_brand">
              <use href="/assets/redesign-theme/uikit/icon/icons.svg#filter" />
            </svg>
          </button>
    ...
    <footer class="footer">
      <div class="footer__wrapper">
        <div class="row spoiler" id="footer-content">
        ...
        <div class="footer__extra-wrap">
          ...
          <div class="footer__spoiler-container">
            <a class="spoiler__control spoiler_closed footer__spoiler-control" data-target="#footer-content" data-name="Свернуть" aria-expanded="false">Развернуть</a>
          </div>
        </div>
