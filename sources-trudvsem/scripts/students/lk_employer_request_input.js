...
(function () {
    ...
    if (currentUser) {
        userDataQuery({
            ...
            getCatalogData(EMPLOYER_CATALOG, { id: [response.data] }).done(function (response) {
    ...
    function prepageRequestData(wrapper) {
        return {
            ...
            id_institution: wrapper.data("institution"),
            id_employer: userData[0],
