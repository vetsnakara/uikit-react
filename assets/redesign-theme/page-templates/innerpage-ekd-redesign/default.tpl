...
<html lang="ru">
  ...
  <body class="for-gosbar">
    <header class="header container-fluid">
      <div class="container">
        <a href="/" title="Работа в России" class="header__logo redesign-elements-header__logo"></a>
      </div>
    </header>
    <main class="container-fluid">
      <div th:replace="fragments/iblocks :: list(*{iblocks})"></div>
    </main>
    <footer class="redesign-elements-footer">
      <div class="redesign-elements-footer__wrapper">
        <div class="row">
          <div class="col-lg-8 col-md-6">
            <div class="row">
              <section class="col-sm-6 redesign-elements-footer__section">
                <a class="redesign-elements-footer__logo" href="/">
                  <img th:src="${@ResourceProcessor.wrap('/assets/redesign-theme/uikit/footer/footer-logo.svg')}" alt="footer-logo" width="46" height="50">
                </a>
                <h5 class="redesign-elements-footer__title">Работа России</h5>
                <a class="redesign-elements-footer__link" href="/">Trudvsem.ru</a>
              </section>
              <section class="col-sm-6 redesign-elements-footer__section">
                <h5 class="redesign-elements-footer__nav-title">Работодатели</h5>
                <a class="redesign-elements-footer__nav-link" href="/cv/search">Найти резюме</a>
                <a class="redesign-elements-footer__nav-link" href="/auth/manager/vacancies/new">Добавить вакансию</a>
                <a class="redesign-elements-footer__nav-link" href="/about/employer">Впервые на сайте</a>
              </section>
              <section class="col-sm-6 redesign-elements-footer__section">
                <h5 class="redesign-elements-footer__nav-title">Общая информация</h5>
                <a class="redesign-elements-footer__nav-link" href="/czn">Государственная служба занятости</a>
                <a class="redesign-elements-footer__nav-link" href="/opendata">Открытые данные</a>
                <a class="redesign-elements-footer__nav-link" href="/opendata/media-partners">Партнеры</a>
                <a class="redesign-elements-footer__nav-link" href="/help">Помощь</a>
              </section>
              <section class="col-sm-6 redesign-elements-footer__section">
                <h5 class="redesign-elements-footer__nav-title">Соискатели</h5>
                <nav class="redesign-elements-footer__nav">
                  <a class="redesign-elements-footer__nav-link" href="/vacancy/search">Найти работу</a>
                  <a class="redesign-elements-footer__nav-link" href="/auth/candidate/cvs/new">Добавить резюме</a>
                  <a class="redesign-elements-footer__nav-link" href="/information-pages/biggest-employers">Крупнейшие работодатели</a>
                  <a class="redesign-elements-footer__nav-link" href="/information-pages/special">Трудоустройство инвалидов</a>
                  <a class="redesign-elements-footer__nav-link" href="/about/candidate">Впервые на сайте</a>
                </nav>
              </section>
            </div>
          </div>
          <section class="col-lg-4 col-md-6 redesign-elements-footer__section">
            <h5 class="redesign-elements-footer__nav-title">Полезные ресурсы</h5>
            <a class="redesign-elements-footer__nav-link" target="_blank" href="https://rostrud.gov.ru/">Роструд</a>
            <a class="redesign-elements-footer__nav-link" target="_blank" href="https://mintrud.gov.ru/">Минтруд России</a>
            <a class="redesign-elements-footer__nav-link" target="_blank" href="https://gossluzhba.gov.ru/">Портал госслужбы</a>
            <a class="redesign-elements-footer__nav-link" target="_blank" href="https://xn--80akibcicpdbetz7e2g.xn--p1ai/">Онлайнинспекция.рф</a>
            <a class="redesign-elements-footer__nav-link" target="_blank" href="http://aiss.gov.ru/">Соотечественники</a>
            <a class="redesign-elements-footer__nav-link" target="_blank" href="https://tpprf.ru/ru/">Торгово-промышленная палата РФ</a>
            <a class="redesign-elements-footer__nav-link" target="_blank" href="https://www.rospotrebnadzor.ru/">Роспотребнадзор</a>
            <a class="redesign-elements-footer__nav-link" target="_blank" href="https://nark.ru/services">Национальная система квалификаций</a>
            <a class="redesign-elements-footer__nav-link" target="_blank" href="http://gsz.gov.by/">Государственная служба занятости Республики Беларусь</a>
            <a class="redesign-elements-footer__nav-link" target="_blank" href="/rbg/">Работа без границ</a>
            <a class="redesign-elements-footer__nav-link" target="_blank" href="https://skillsnet.ru/">Социальная сеть "SkillsNet"</a>
          </section>
        </div>

        <div class="redesign-elements-footer__important">
          <a class="redesign-elements-footer__nav-link" href="/help/security">Меры безопасности</a>
          <a class="redesign-elements-footer__nav-link" href="/help">Техническая поддержка</a>
          <a class="redesign-elements-footer__nav-link" target="_blank" href="/information/resources/upload/main-page/politic_personal_data.pdf">Политика обработки персональных данных</a>
        </div>

        <hr class="redesign-elements-footer__separator">

        <div class="row">
          <div class="col-12 col-sm mb-1 redesign-elements-footer__copyright">&copy;&nbsp;Федеральная служба по труду и занятости —
