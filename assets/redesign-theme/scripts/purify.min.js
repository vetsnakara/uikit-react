...
!(function (e, t) {
    ...
    var m,
        ...
        h = x(String.prototype.toLowerCase),
    ...
    return (function e() {
        ...
        if (((n.version = "2.3.3"), (n.removed = []), !t || !t.document || 9 !== t.document.nodeType))
        ...
        var r = t.document,
            ...
            u = t.NodeFilter,
            m = t.NamedNodeMap,
            x = void 0 === m ? t.NamedNodeMap || t.MozNamedAttrMap : m,
            V = t.Text,
            X = t.Comment,
            $ = t.DOMParser,
            Z = t.trustedTypes,
        ...
        var pe = z,
            ...
            Te = j,
            Ae = null,
            xe = S({}, [].concat(q(R), q(_), q(N), q(k), q(M))),
            Se = null,
            we = S({}, [].concat(q(L), q(F), q(I), q(C))),
            Ee = null,
            Re = null,
            _e = !0,
            Ne = !0,
            ...
            it = function (e) {
                (rt && rt === e) ||
                    ...
                    (Se = "ALLOWED_ATTR" in e ? S({}, e.ALLOWED_ATTR) : we),
                    (Ye = "ADD_URI_SAFE_ATTR" in e ? S(w(Ke), e.ADD_URI_SAFE_ATTR) : Ke),
                    (Ge = "ADD_DATA_URI_TAGS" in e ? S(w(qe), e.ADD_DATA_URI_TAGS) : qe),
                    (Be = "FORBID_CONTENTS" in e ? S({}, e.FORBID_CONTENTS) : We),
                    (Ee = "FORBID_TAGS" in e ? S({}, e.FORBID_TAGS) : {}),
                    ...
                    (Ze = e.NAMESPACE || $e),
                    (Qe = Qe = -1 === et.indexOf(e.PARSER_MEDIA_TYPE) ? tt : e.PARSER_MEDIA_TYPE),
                    (nt =
                    ...
                    je &&
                        ((Ae = S({}, [].concat(q(M)))),
                        (Se = []),
                        !0 === je.html && (S(Ae, R), S(Se, L)),
                        !0 === je.svg && (S(Ae, _), S(Se, F), S(Se, C)),
                        !0 === je.svgFilters && (S(Ae, N), S(Se, F), S(Se, C)),
                        !0 === je.mathMl && (S(Ae, k), S(Se, I), S(Se, C))),
                    e.ADD_TAGS && (Ae === xe && (Ae = w(Ae)), S(Ae, e.ADD_TAGS)),
                    e.ADD_ATTR && (Se === we && (Se = w(Se)), S(Se, e.ADD_ATTR)),
                    e.ADD_URI_SAFE_ATTR && S(Ye, e.ADD_URI_SAFE_ATTR),
                    e.FORBID_CONTENTS && (Be === We && (Be = w(Be)), S(Be, e.FORBID_CONTENTS)),
                    Ue && (Ae["#text"] = !0),
                    Oe && S(Ae, ["html", "head", "body"]),
                    Ae.table && (S(Ae, ["tbody"]), delete Ee.tbody),
                    i && i(e),
                    (rt = e));
            },
            at = S({}, ["mi", "mo", "mn", "ms", "mtext"]),
            lt = S({}, ["foreignobject", "desc", "title", "annotation-xml"]),
            ct = S({}, _);
        S(ct, N), S(ct, D);
        var st = S({}, k);
        S(st, O);
        var ut = function (e) {
            ...
            dt = function (e) {
                ...
                return (
                    ...
                    Ze === $e ? ue.call(t, Oe ? "html" : "body")[0] : Oe ? t.documentElement : a
                );
            },
            pt = function (e) {
            ...
            vt = function (e) {
                ...
                var r = nt(e.nodeName);
                if (
                    (yt("uponSanitizeElement", e, { tagName: r, allowedTags: Ae }),
            ...
            At = function e(t) {
                ...
                for (yt("beforeSanitizeShadowDOM", t, null); (n = r.nextNode()); )
                    yt("uponSanitizeShadowNode", n, null), vt(n) || (n.content instanceof a && e(n.content), Tt(n));
        ...
        return (
            (n.sanitize = function (e, o) {
                ...
                if ((Me || it(o), (n.removed = []), "string" == typeof e && (Pe = !1), Pe));
                ...
                for (var f = pt(Pe ? e : i); (s = f.nextNode()); )
                    (3 === s.nodeType && s === u) || vt(s) || (s.content instanceof a && At(s.content), Tt(s), (u = s));
                if (((u = null), Pe)) return e;
                if (Fe) {
                    if (Ie) for (m = se.call(i.ownerDocument); i.firstChild; ) m.appendChild(i.firstChild);
                    else m = i;
